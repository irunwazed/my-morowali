    ...
    Route::group(['middleware' => 'cek_level:2'], function () {
        Route::prefix("/admin")->group(function () {
            ...
            Route::prefix("/print")->group(function () {
                ...
                Route::get("/kesejahteraan/stream_v2", [PrintController::class, 'print_kesejahteraan_stream_v2'])->name('print.kesejahteraan.streamv2');
                ...
                Route::get("/penduduk/stream_v2", [PrintController::class, 'print_penduduk_stream_v2'])->name('print.penduduk.stream_v2');
