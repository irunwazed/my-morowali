...
@section('judul', 'Data Jenis Bahan Bakar - SEPAKAD')
            ...
            <div class="card">
                <div class="card-header gradient-purple-indigo 0-hidden pb-80">
                    <div class="pt-4">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class=" text-white">Tabel Jenis Bahan Bakar</h4>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Jenis Bahan Bakar</h5>
                ...
                <div class="modal-body">
                    <form id="form_data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Bobot</label>
                                <input id="bobot" name="bobot"  type="number" class="form-control angka" required="" step="0.1" min="0" max="1" />
...
@section('tambah_js')
    ...
    <script>
        ...
        function edit_data(id) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ env('API_URL') }}/kemiskinan/kesejahteraan/indikator/bahan-bakar/" + id,
                headers: {
                    "Authorization": "Bearer {{ Session::get('token') }}"
                },
                success: function(data) {
